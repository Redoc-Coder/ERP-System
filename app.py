import os
from flask import Flask, render_template, request, url_for, redirect, session, request, jsonify
...
def Cart():
    if 'user_id' in session:
        ...
        return render_template("cart.html", products=user_cart, cart_count=cart_count, total_price=total_price)
    else:
